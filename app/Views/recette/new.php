...
<form action="/recette" method="post">
    ...
    <div style="margin: 4%;">
        <label for="titre" class="label" style="margin-bottom: 15px">
            <span>Titre</span>
            <input type="text" name="titre" class="text-form" >
        </label>
        <br><br>
        <label for="slug" class="label" style="margin-bottom: 15px">
            <span>Slug</span>
            <input type="text" name="slug" class="text-form" >
        </label>
        <br><br>
                    ...
                    <tr>
                        ...
                        <td>
                            <label for="quantite" style="margin-bottom: 15px">
                                ...
                                <input type="text" name="quantite_<?php echo $i ?>" class="text-form">
                            </label>
                        </td>
                        <td>
                            <label for="nom" style="margin-bottom: 15px">
                                <input type="text" name="nom_<?php echo $i ?>" class="text-form">
                            </label>
                        </td>
                    </tr>
                <?php endfor; ?>
